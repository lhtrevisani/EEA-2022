...
A: 
$$
E(peso) = \beta_{0} + \beta_{1} altura+ \beta_{2} edad+ \beta_{3} genero + \beta_{4} consumoSemanalSnacks + \beta_{5} consumoSemanalGaseosa + \beta_{6} diasConsumoComidaRapida + \beta_{7} genero.edad + \beta_{8} genero.altura
$$ 

B:

$$
E(peso) = \beta_{0} + \beta_{1} altura+ \beta_{2} edad+ \beta_{3} genero + \beta_{4} consumoSemanalSnacks + \beta_{5} frecuenciaHambreSemanal + \beta_{6} genero.edad + \beta_{7} genero.altura
$$
...
El segundo modelo propuesto, además de la interacción entre género y altura, incorpora la frecuencia de hambre semanal.
...
```{r}
encuesta_salud <- read.csv("encuesta_salud_modelo6.csv")
